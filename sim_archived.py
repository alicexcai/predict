...
'''
TODO:
-decide on data structure for history within round and across rounds
...
def Cost(shares, liquidity):
    ...
    # global update prices - move this outside Cost method immediately following the mmethod?
    for outcome in outcomes:
        prices[outcome].append(costs[outcome]) 
    
    return costs # returns an array of costs for each outcome
